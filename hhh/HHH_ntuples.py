...
class Analysis():
    ...
    def __init__(self, cmdline_args):
        ...
        # ttbb emutau sample:
        # to run the lephad channel, just un-comment the following (and comment the second directory)
        ...
        self.output_dir = "hadhad_test"

        # important for the Oxford cluster: change to your username (otherwise priority will get tanked)
        self.comp_group = ""
       


        # for quicker testing you can specify a smaller subset to run over (10k events)
        self.test_file = "/data/atlas/users/dingleyt/FCChh/eventProd/EventProducer/FullStatistics_tautau/fcc_v07/II/mgp8_pp_hhh_84TeV/events_000910581.root"    
    ...
    def analyzers(self, dframe):
        ...
        dframe2 = (
            dframe
                ...
                # commented out unless doing pT response checks!
...
#
        ...
        dframe0 = (
                ...
                # leading four b-jets (used in Loose Preselection)
        ...
        dframe4 = (
                ...
                .Define("h1_b1", "h1_bb.first") # these should be MCParticles
        ...
        dframe5 = (
                ...
                .Define("WlWlFilter", "AnalysisFCChh::WWlvlvFilter_HHH(mc_particles, mc_daughters, mc_parents)")
        ...
        dframe8 = (
                ...
                .Define("hres_dR",
                        "AnalysisFCChh::getHiggsCandidates(sel_eta_b_me, TString(\"dRminmax\"), 125.f, 120.f)")
                .Define("higgs_pairs_dR",      "hres_dR.pairs")
                
                # also by mass pairings
                .Define("hres_absmass",
                        "AnalysisFCChh::getHiggsCandidates(sel_eta_b_med, TString(\"linearmass\"), 125.f, 120.f)")
                .Define("higgs_pairs_absmass",      "hres_absmass.pairs")

                .Define("hres_squaremass",
                        "AnalysisFCChh::getHiggsCandidates(sel_eta_b_med, TString(\"squaremass\"), 125.f, 120.f)")
                ...
                .Define("sigma", "AnalysisFCChh::compute_sigma(h1_tlv_dR, h2_tlv_dR, best_tautau_TLVs[2])")
                ...
                .Define("m_tautau_col", "AnalysisFCChh::ditau_mass_collinear(tau_1_tlv_LH, tau_2_tlv_LH,  MET_x, MET_y)")
